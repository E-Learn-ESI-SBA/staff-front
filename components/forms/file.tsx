...
export function FileForm({ defaultValues= {id:"",name:"",groups:[],section_id: ""}, mode = "CREATE", children }: Props) {
  const { currentMap,setButtonLoading, onError, onSubmit } = useModuleTreeStore((state) => ({
  ...
  return (
    <Form {...form}>
      ...
      >
        <h2 className="text-lg font-semibold">{mode === "UPDATE" ? "Edit" : "Create"} File </h2>
