  ...
  return (
    <div className="p-2 relative">
        ...
        <div className="fixed top-4 left-0 right-0 z-50 w-full p-4 max-h-full">
          ...
          <div className="fixed inset-0 z-50 flex justify-center items-center">
            <div className="relative bg-white rounded-lg shadow max-w-sm w-full h-fit py-8 px-4 flex flex-col">
              <div className="flex flex-col gap-4 font-normal py-4">
                <p className="text-lg font-medium">Are you sure you want to leave?</p>
                <p>
                  If you leave the page, your answers will be submitted and the quiz
              ...
              <div className="flex justify-end gap-2">
                ...
                <Link href="/" className="rounded-md px-4 py-1 bg-blue-500 self-end text-white" onClick={handleSubmit}>
                  Leave and Submit
                </Link>
              </div>
            </div>
      ...
      <div className="flex justify-between items-center font-medium">
        ...
        <p className={` fixed right-2 text-2xl ${timeLeft <= duration * 12 && 'text-red-500'} `}>Timer : <span>{formatTime(timeLeft)}</span></p>
      </div>
