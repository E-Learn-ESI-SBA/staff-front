...
<div className="col-span-2 flex flex-col items-center gap-8 ">
            ...
            <div>
					<h3 className="mb-6 font-semibold text-xl text-white ">{footer.linksTitle} </h3>
           ...
           {footer.links.map((link,i) =>
                ...
                <div>
                <h3 className="mb-6 font-semibold text-xl text-white ">{footer.contactTitle}</h3>
					<ul>
					{footer.contactItems.map((item,i) =>
		    		 <li key={i}   className="flex justify-start items-center gap-2">
                    <Image src={item.icon} alt='cs' width={0} height={0} sizes='100vw' className=" h-4 w-4 "  />
                ...
                <Image src={footer.address.icon} alt='cs' width={0} height={0} sizes='100vw' className=" h-4 w-4 "  />
	...
	<div className="h-[2px] w-full bg-white opacity-20 "/>
			<Image src='/landing/footer/cs.svg' alt='cs' width={0} height={0} sizes='100vw' className="absolute h-16 w-24 opacity-20 "  />
	</div>
		...
		<div className="mt-8 flex max-md:flex-col max-md:justify-center  items-center md:justify-between">
			...
			{footer.socialLinks.map((link,i) =>
			   ...
			   <Image src={link.icon} alt='cs' width={0} height={0} sizes='100vw' className=" h-6 w-6 "  />
						</Link> 
		   )}
			</div>
