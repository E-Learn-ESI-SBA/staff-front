...
const Courses = () => {
    return (
      ...
      <div className="grid gridview gap-8  max-w-screen-lg mx-auto py-8 px-2 relative">
        ...
        <Image src="/landing/courses/cs.svg" alt="cs" width={0} height={0} sizes="100vw" className="h-10 w-10 sm:h-10 sm:w-10 absolute -top-8 left-4 opacity-25" />
        <Image src="/landing/courses/star.svg" alt="cs" width={0} height={0} sizes="100vw" className="h-10 w-10 sm:h-8 sm:w-8 absolute -top-2 right-2" />
      </div>
      <div className="flex items-center">
        <Link href="/" className="px-8 py-2 mx-auto font-medium border rounded-tl-3xl rounded-br-3xl">
          Learn More
        </Link>
      </div>
    </div>
