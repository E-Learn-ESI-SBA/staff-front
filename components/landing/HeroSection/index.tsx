...
const HeroSection = () => {
    return (
     ...
     <div className="flex flex-col items-center justify-center gap-8  col-span-3 sm:col-span-2 " >
      ...
      <p className='text-lg sm:text-3xl font-bold -mt-4   ' >Madaurus ESI-SBA</p>
   ...
   <Link href="/" className=" max-sm:text-sm px-4 sm:px-8 py-2 mx-auto font-medium border rounded-tr-3xl rounded-bl-3xl opacity-50">
        ...
        <Image src="/landing/heroSection/rocket.svg" alt="cs" width={0} height={0} sizes="100vw" className="  w-full sm:h-[400px]  -mt-12   " />
     </div>
