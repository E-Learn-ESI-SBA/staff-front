    ...
    return (
        <div className="relative w-full h-full p-4  flex flex-col gap-2">
            <div className="flex gap-4 items-center  justify-end">
                ...
                <Button className={`p-6  text-sm ${usageMode == "read" ? "text-text-GRAY" : "text-red-origin"} w-fit self-end`} variant="outline" > Mode: {usageMode.toLocaleUpperCase()} </Button>
                <Button className=" p-6  text-sm text-blue-origin w-fit self-end" variant="outline"> {saveStatus} </Button>
