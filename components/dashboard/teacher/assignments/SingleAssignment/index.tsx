...
const SingleAssignment: React.FC = () => {
    ...
    const files = [
  { name: 'example_file1.txt', url: 'https://example.com/files/example_file1.txt' },
  { name: 'example_file2.png', url: 'https://example.com/files/example_file2.png' },
];
  return (
    <div className='p-4  bg-[#F4F7FE] ' >
    <Tabs defaultValue={tabs[0]} className="w-full border border-[#EAEAEA] bg-white min-h-screen   ">
