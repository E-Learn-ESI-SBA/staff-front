...
import { AccordionOneContent, AccordionOneContentProps } from "./accordion-content"
...
export default function ResourcesAccordion() {
    return (
        <div>
            ...
            <Accordion type="single" collapsible className="w-full text-black px-14">
                {content.map((item, index) => (
                    <AccordionItem key={index} value={`item-${index}`}>
                        <AccordionTrigger dir="rtl" className="hover:no-underline hover:text-primary">
