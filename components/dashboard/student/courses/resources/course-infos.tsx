...
export const CourseInfosTtile = ({ title, sections, lectures, time }: CourseInfosTtileProps) => {
    return (
        <div className="bg-white mx-8 p-8 rounded-2xl my-4">
            <div className='flex justify-between'>
                ...
                <Button className='bg-primary text-white text-lg px-8 py-[1.8rem]'>Write A Review</Button>
            </div>
        </div>
    )
}
