  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-2 text-bold py-8">
        <Image
          src="/landing/testimonials/person.png"
          alt="cs"
          width={0}
          height={0}
          sizes="100vw"
      ...
      <div className="rounded-3xl  border-2 border-[#DADADA]  my-8 max-xl:mx-2  mx-auto flex flex-col px-2 items-center  md:grid md:grid-cols-2  xl:grid-cols-4 p-8  md:gap-x-4 gap-y-8 max-w-screen-xl ">
        <div className="flex flex-col items-start gap-4 col-span-2">
          <p className="text-xl font-semibold text-[#3C3C3C] ">
