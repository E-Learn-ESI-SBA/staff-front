    ...
    return (
        <div className=" text-gray-thin flex flex-row  justify-between feed_border">
            <div className='flex flex-row items-center gap-6'>
                <Item Icon={Rocket} text='Best' active={active == 'Best'} onClick={setActive}/>
                <Item Icon={Flame} text='Hot' active={active == 'Hot'} onClick={setActive}/>
                <Item Icon={Sparkle} text='New' active={active == 'New'} onClick={setActive}/>
                <Item Icon={ArrowUpFromDot} text='Top' active={active == 'Top'} onClick={setActive}/>
            </div>
