...
import { Image, Link, Youtube, Paperclip, Settings2, ChevronDown, ChevronDownIcon } from "lucide-react";
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        <Select>
                          <SelectTrigger className="w-[200px] focus-visible:ring-0 focus:ring-0 border-gray-400 text-black text-lg">
                            <SelectValue defaultValue="public" className="font-bold" placeholder="Public" />
                          </SelectTrigger>
                      ...
                      <Button type="submit" className="rounded-full text-xl px-8 py-6">Share</Button>
                  </div>
                </DialogFooter>
              </DialogContent>
            </Dialog>
