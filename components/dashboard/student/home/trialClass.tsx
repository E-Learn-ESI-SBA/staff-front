...
export default function TrialClass() {
  return (
    <div className='flex bg-white rounded-3xl h-[22rem] p-12 justify-between'>
        <div>
            <h1 className='text-5xl text-secondary font-medium'>Learn Python <br/> within 30 Days</h1>
            <p className='text-text py-8'>Time to become advance then <br></br> others with this course </p>
            <div>
